...
def generate_launch_description():
    ...
    # Option for ground truth odometry
    delcare_use_ground_truth = DeclareLaunchArgument(
        "use_ground_truth", default_value="False", 
        description= "Disables odometry estimation." 
    )
    ...
    state_estimator_node = Node(
        ...
        condition=UnlessCondition(PythonExpression(LaunchConfiguration("use_ground_truth")))
    )
